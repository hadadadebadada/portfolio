  ...
  return (
    <Div1>
      <Div2>
        ...
        <img src='images/R/itemfrequency.png' width="800" height="500" />
        <Div3><br></br></Div3>
        ...
        <img src='images/R/aprioriLinien.png' width="800" height="500" />
        ...
        <img src='images/R/graph.png' width="800" height="600" />
        <TagLine>Weitere Visualisierungsmöglichkeiten und eine vollständige Beschreibung finden Sie hier:</TagLine>
        <h1><a href="https://online.flippingbook.com/view/22126881/">Link zum vollständigen Paper</a></h1>
        <Div3><br></br></Div3>
        ...
        <img src='images/R/summary.png' />
        <Div3><br></br></Div3>
        <img src='images/R/diagnose1.png' />
        <Div3><br></br></Div3>
        <img src='images/R/diagnose2.png' />
        ...
        <img src='images/R/regression.png' />
        <Div3><br></br></Div3>
        <Div3><br></br></Div3>
